...
class _LocationRegState extends State<LocationReg> {
  ...
  */}
  ...
  Future<void> onPress() async{
    ...
    Map js = {"medicines":[],"reminders":[],"relatives":[],"messages":[],"memory_score":0,"emergency_pno":pno,"patient_name":name,"patient_location":{'loc':loc.latitude,'lat':loc.longitude},'patient_dp':imageUrl}; //ADD OTHER INFO
